<main>
  <article>
    ...
    <section>
      ...
      <p>That is where <strong>domain names</strong> come in. Domain names provide a human-readable address that corresponds to a server on the internet for users to easily access its content. IP addresses are hard to remember and can change over time, so domain names act as an alias for a server which saves us a lot of trouble.</p>
